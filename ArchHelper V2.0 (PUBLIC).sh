...
uservar=$USER
sudo chown -R $input /home/$uservar/yay 
cd yay
makepkg -si
yay -Syu
tput sgr4 
...
sleep 0.1
echo "4 - Wine and additional gaming components (Steam, Lutris, etc...)"
sleep 0.1
echo "5 - Install all"
tput setaf 4 
echo "What would you like to install? (1-5)"
...
yay 
 ...
 tput setaf 3 
echo "You should enter a valid number! (1-5)"
sleep 1 
menu 
fi
}
...
This script can help you install various unseful components to your system. 
Press enter to proceed to the menu
(Also avoid running the script as SUDO as it may cause problems with installation)"
